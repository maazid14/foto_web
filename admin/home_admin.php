...
<body class="bg-gray-300 font-sans">
    ...
    <div class="flex-1 p-9">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="../admin/admin_add_album.php"
                class="bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">Add Album</a>
            <a href="../admin/profil_admin.php"
                class="bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">Profil admin</a>
