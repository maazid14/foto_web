...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex-1 p-8">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="admin_add_foto.php?album_id=<?php echo $album['album_id']; ?>"
        ...
        <div class="photos-container">
            ...
            <div class="photo-card">
                ...
                <div class="photo-actions">
                    ...
                    <!-- Delete Button -->
                    <a href="admin_delete_foto.php?id=<?php echo $photo['photo_id']; ?>"
                ...
                <div class="photo-actions">
                    <!-- Like Button -->
                    <a href="admin_like.php" class="btn btn-like" data-photo-id="<?php echo $photo['photo_id']; ?>"
